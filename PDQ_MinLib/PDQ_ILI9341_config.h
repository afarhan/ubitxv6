...
#define ILI9341_SAVE_SPI_SETTINGS 1     // <= 0/1 with 1 to save/restore AVR SPI control and statusregisters (required when other SPI devices are in use with other settings)
