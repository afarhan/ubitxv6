...
#define CAL_CLK (5)        // The 30 MHz LPF is permanently connected in the output of the PA... 
...
#define PPS_IN   (2)          //  Pin goes high during CW keydown to transmit the carrier. 
